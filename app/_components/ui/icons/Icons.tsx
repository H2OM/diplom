type IconsType = 'filedHeart' | 'unfiledHeart';

export function Icons({type}: {type: IconsType}) {
    switch (type) {
        case 'unfiledHeart':
            return <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-suit-heart" viewBox="0 0 16 16">
